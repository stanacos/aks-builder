...
resource fw_pip 'Microsoft.Network/publicIPAddresses@2025-05-01' = {
...
resource fwManagementIp_pip 'Microsoft.Network/publicIPAddresses@2025-05-01' = if(fwSku=='Basic') {
...
resource fw 'Microsoft.Network/azureFirewalls@2025-05-01' = {
  name: fw_name
  location: location
  zones: !empty(availabilityZones) ? availabilityZones : []
  properties: {
...
resource fwpRules 'Microsoft.Network/firewallPolicies/ruleCollectionGroups@2025-05-01' = {
  parent: fwPolicy
